...
import dayFour.producerConsumer.PCDExample.Buffer;
...
class PCDExampleTestSuite {
	...
	/**
	 * Test method for {@link dayFour.producerConsumer.PCDExample#main(java.lang.String[])}.
	 */
	@Test
	void testMain() {
	...
	/**
	 * Test method for {@link dayFour.producerConsumer.PCDExample.Buffer#enqueue(int)}.
	 */
	@Test
	void testEnqueue() {
	...
	/**
	 * Test method for {@link dayFour.producerConsumer.PCDExample.Buffer#dequeue()}.
	 */
	@Test
	void testDequeue() {
		Buffer buffer = new PCDExample.Buffer();
	...
	/**
	 * Test method for {@link dayFour.producerConsumer.PCDExample.Buffer#clear()}.
	 */
	@Test
	void testClear() {
		Buffer buffer = new PCDExample.Buffer();
