 ...
 * 
 */
package dayFive.dateTime.tests;

import static org.junit.jupiter.api.Assertions.*;

import org.junit.jupiter.api.Test;

import dayFive.dateTime.examples.TimeExamples;
...
class TimeExamplesTest {
	...
	/**
	 * Test method for {@link dayFive.dateTime.examples.TimeExamples#monthLength(int, int)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link dayFive.dateTime.examples.TimeExamples#getMondays(int)}.
	 */
	@Test
	void testGetMondays() {
		TimeExamples mlfy = new TimeExamples();
	...
	/**
	 * Test method for {@link dayFive.dateTime.examples.TimeExamples#isFridayTheThirteenth(int, int, int)}.
	 */
	@Test
